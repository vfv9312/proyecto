...
class ProductosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $productos = productos::join('precios_productos', 'productos.id', '=', 'precios_productos.id_producto')
            ...
            ->paginate(5)->appends(['adminlteSearch' => $busqueda, 'marca' => $busquedaMarca, 'tipo' => $busquedaTipo, 'color' => $busquedaColor, 'tipo' => $busquedaCategoria]); // Mueve paginate() aquí para que funcione correctamente
