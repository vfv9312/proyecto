        <!-- Modal -->
        <div id="modalRegistrarTipoProducto" class="fixed inset-0 z-10 hidden overflow-y-auto" aria-labelledby="modal-title"
                    ...
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        ...
                        <form method="POST" action="{{ route('tipos.store') }}"
                            ...
                            <label class="flex flex-col items-start text-sm text-gray-500">
                                <span id="nombreLabel">Nombre del tipo de producto</span>
