    ...
    <table class="min-w-full">
        ...
        @foreach ($preventas as $index => $pendiente)
            ...
            <tr class= "text-sm border-b border-gray-200 ">
                <td class="px-6 py-4">{{ $pendiente->tipoVenta == 'Entrega' ? $pendiente->letraActual : $pendiente->letraActual_r }}{{ $pendiente->tipoVenta == 'Entrega' ? sprintf('%06d', $pendiente->ultimoValor) : sprintf('%06d', $pendiente->ultimoValor_r) }}
                </td>
                ...
                <td>
                    <div class="flex items-center me-4">
                        ...
                        <label for="red-checkbox"
                            class="text-sm font-medium text-gray-900 ms-2 dark:text-gray-300">Eliminacion</label>
                    </div>
                </td>
