...
<div class="flex flex-wrap px-6 py-4 mt-5 -mx-3 whitespace-no-wrap border-b border-gray-200">
    <div class="w-full px-3 mb-6 md:w-1/3 md:mb-0">
        ...
        <input
            class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
            id="telefono_cliente" type="text" name="txttelefono_cliente"
             pattern="\d{10}" maxlength="10" placeholder="Ingrese su número de teléfono"
            value=" {{ $ordenRecoleccion->telefonoCliente }}" oninput="updateWhatsAppLink()">
    </div>
    <div class="w-full px-3 mb-6 md:w-1/3 md:mb-0">
        <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase">
            RFC
    ...
    <div class="w-full px-3 mb-6 md:w-1/3 md:mb-0">
        ...
        <input
            class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
            id="atencion" type="email" name="txtcorreo_Cliente" placeholder="Ingrese un correo electronico" value="{{ $ordenRecoleccion->correo }}" readonly>
    </div>
</div>
<div class="flex flex-wrap px-6 py-4 mt-5 -mx-3 whitespace-no-wrap border-b border-gray-200">
