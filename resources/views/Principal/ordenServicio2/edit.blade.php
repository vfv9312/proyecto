...
@section('content')
    <h1 class="mb-0 font-bold text-center ">Estatus {{$datosEnvio->estado}}</h1>
    <form id="formularioEdit" class="" action="{{ route('orden_recoleccion.edit', ['orden_recoleccion' => $datosEnvio->idPreventa]) }}"
        method="GET">
        @csrf
