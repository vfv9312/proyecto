<section class="flex flex-col px-3 pb-3 mt-8 border-4">
    ...
    <label class="flex items-center mt-2 mb-2 cursor-pointer">
        <span class="mr-2 text-sm font-medium text-gray-900 ms-3 dark:text-gray-300">Productos</span>
        <input id="productoRecarga" type="checkbox" value="true" class="sr-only peer">
        <div
        ...
        <span class="text-sm font-medium text-gray-900 ms-3 dark:text-gray-300">Revision</span>
    </label>


    <div class="flex flex-col mt-4 space-y-4 lg:flex-row lg:space-y-0 lg:space-x-4">
