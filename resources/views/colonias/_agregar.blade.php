        <!-- Modal -->
        <div id="modalRegistrarColonia" class="fixed inset-0 z-10 hidden overflow-y-auto" aria-labelledby="modal-title"
                    ...
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        ...
                        <form method="POST" action="{{ route('colonias.store') }}"
                            ...
                            <label class="flex flex-col items-start text-sm text-gray-500">
                                <span id="nombreLabel">Nombre de la Colonia</span>
                        ...
                        @enderror
                            <label class="flex flex-col items-start text-sm text-gray-500">
                                ...
                                <input name="codigopostal"
                                    title="Por favor ingresa el codigo postal"
                                    type="number":
                                    step="1"
                                    class="border-2 border-blue-500 focus:ring-2 focus:ring-blue-300 focus:outline-none" />
                                @error('codigopostal')
                            ...
                            <button type="submit" id="enviarmodal"
                                class="inline-flex justify-center w-full px-4 py-2 mt-2 text-base font-medium text-white bg-green-700 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
